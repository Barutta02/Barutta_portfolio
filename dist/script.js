...
p1light.position.set(0.2, 0, 1.1);
...
manager.onLoad = function () {
  console.log("loaded");
  loadingContent++;
  if (loadingContent == 6) $("#loadingDIV").css("display", "none");
};
...
function init() {
  ...
  sphere = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "../static/images/worldBest.jpg",
        manager.onLoad()
      ),
      bumpMap: new THREE.TextureLoader().load(
        "../static/images/elev_bump_4k.jpg",
        manager.onLoad()
      ),
      bumpScale: 0.005,
      specularMap: new THREE.TextureLoader().load(
        "../static/images/water_4k.png",
        manager.onLoad()
      ),
  ...
  cloud = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(
        "../static/images/fair_clouds_4k.png",
        manager.onLoad()
      ),
      transparent: true,
    })
...
const tick = () => {
  ...
  p1light.position.set(0.2, 0, camera.position.z + 0.2);
...
function updateCamera(ev) {
  ...
  if (
    sphere.rotation.y <= 4.5127998046875 ||
...
tween
  ...
  .to(
    ...
    1,
    {
      ...
      onReverseComplete: function () {
        ...
        macWinContactID.innerHTML =
          "Andrea Barutta, Padova IT [Versione 04/03/2002]<BR> > world.getDevelopers().getByName(<p style='font-weight:bold;display:contents; '>'Andrea Barutta'</p>).getContact() <br>            <BR>> PRESS ENTER:<br> ";
      },
    },
    9
  )
  ...
  .to(
    ...
    2,
    {
      ...
      onComplete: function () {
        $("#sottotitoli").text(
          "I have always played volleyball in important clubs in northern Italy."
        );
      },
      onReverseComplete: function () {
        $("#sottotitoli").text("");
  ...
  .to(
    ...
    1,
    {
      ...
      onComplete: function () {
        $("#sottotitoli").text(
          " This allowed me to improve my time management skills given the many workouts combined in the studio."
        );
      },
      onReverseComplete: function () {
        $("#sottotitoli").text(
  ...
  .to(
    ...
    1,
    {
      ...
      onComplete: function () {
        $("#sottotitoli").text(
          "In high school I discovered my passion for computer science born from small school projects like this memory."
        );
        $(".card").css("opacity", "1");
  ...
  .to(
    ...
    1.5,
    {
      ...
      onComplete: function () {
        $("#sottotitoli").text(
          "So I decided to dedicate some of the time I dedicated to sport to the study of computer programming and web developing."
        );
  ...
  .to(
    ...
    1,
    {
      ...
      onComplete: function () {
        $("#sottotitoli").text(
          "Today I continue to study whatever can be useful to my passion for programming and when I can I try to add a little creativity and good taste to my ideas."
        );
      },
      onReverseComplete: function () {
        $("#sottotitoli").text(
...
var j = 0;
var txt =
  "< > email: andreabarutta123@gmail.com < > instagram: andrea.barutta < > To continue my story keep scrolling... ";
var speed = 50;
...
function controlSameColor() {
  if (
    memory[cardTurn[0].split("_")[1]] == memory[cardTurn[1].split("_")[1]] &&
    cardTurn[0] != cardTurn[1]
  ) {
    cardFound++;
